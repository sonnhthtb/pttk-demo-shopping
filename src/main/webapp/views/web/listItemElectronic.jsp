                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="card h-100" >
                                <form action="/addToCart" method="post">
                                    <a href="/detailItemElectronic?id=${item.id}"><img class="card-img-top" src="${item.imageUrl}" alt=""></a>
                                    <div class="card-body" style="margin-bottom: 50px">
                                        <h4 class="card-title">
                                            <a href="/itemElectronic?id=${item.id}">${item.electronic.name}</a>
                                        </h4>
                                        <h5>${item.price} đ</h5>
